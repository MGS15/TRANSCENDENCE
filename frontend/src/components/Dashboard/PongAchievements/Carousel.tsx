...
export default function Carousel(){
  ...
  return (
    <div  className="carousel min-[0px]:mx-5 2xl:m-auto flex flex-col justify-center border-solid border-4 border-black max-w-[1536px] bg-[#F6F4F0] shadow-[2px_4px_0px_0px_#000301]">
      <div>
        <h1 className="title font-Nova text-center font-bold min-[0px]:text-xl xl:text-2xl text-3xl p-4 border-4 border-solid border-black m-9 mb-0 shadow-[2px_4px_0px_0px_#000301] bg-white"> PONG ACHIEVEMENTS</h1>
      </div>
      <div
        className="overflow-hidden snap-mandatory snap-x inner whitespace-nowrap border-4 border-solid boder-black m-9 shadow-[2px_4px_0px_0px_#000301]"
      >
        {items.map((item) => {
          return(
