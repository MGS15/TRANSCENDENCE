	...
	return (
		<div>
			...
			<div className='BigDiv gap-14 max-w-[1536px] m-auto lg:p-4 min-[0px]:flex-row min-[730px]:flex lg:flex min-[0px]:mx-5 2xl:m-auto 2xl:mt-10'>
				...
				<div className='RightDiv flex flex-col justify-content-center min-[0px]:w-[85%] sm:w-[75%] min-[730px]:w-[75%] m-auto'>
					...
					<div className='flex justify-center py-10 border-solid border-black border-2 min-[0px]:p-7'>
						<img src={startGame} className='StartGame transition duration-500 ease border-solid border-black border-2'></img>
					</div>
				</div>
			</div>
		</div>
