...
export default function HomePageDiv(){
	return (
	  <div className='bg-BkColor min-[0px]:flex-row sm:flex-row md:flex-row lg:flex min-[0px]:mx-5 2xl:m-auto justify-between items-center border-solid border-2 border-black shadow-[2px_4px_0px_0px_#000301] box-border p-3 max-w-[1536px]'>
