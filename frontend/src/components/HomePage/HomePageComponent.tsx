	...
	return (
	  <div className='bg-BkColor flex mx-5 2xl:m-auto justify-between items-center border-solid border-4 border-black shadow-[2px_4px_0px_0px_#000301] p-3 max-w-[1536px]'>
		<div className='flex flex-col place-items-center min-[1199px]:items-start w-[100%] min-[1199px]:w-[60%] p-5 2xl:p-0 gap-y-11 lg:m-9'>
			<p className='ml-[-50px] min-[400px]:ml-0 truncate animate-[pulse_2.6s_ease-in-out_infinite] TrTitle text-clip text-primary text-center xl:text-left px-6 min-[1199px]:m-0 min-[1199px]:px-0 text-xs sm:text-2xl md:text-3xl lg:text-5xl font-pixelify w-full'>TRANSCENDENCE PINGPONG GAME</p>
			...
			<button className='min-[1199px]:ml-6 text-xs min-[545px]:text-2xl bg-buttonColor rounded-full font-pixelify border-solid border-4 border-black shadow-[2px_4px_0px_0px_#000301] p-2 sm:p-4 w-[100%] min-[200px]:w-[60%] min-[550px]:text-base min-[550px]:w-[40%] sm:w-[50%] md:w-[35%] min-[1199px]:w-1/2'>JOIN US NOW</button>
		</div>
