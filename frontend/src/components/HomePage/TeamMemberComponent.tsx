...
export const TeamLinks = [
	...
	},
	{
		...
		InstagramLink : "https://instagram.com/MGS15",
		LinkedinLink : "",
...
export default function TeamMember(props: any){
	return (
		<div className={`Member ${props.Color} transition duration-500 ease-in-out font-pixelify max-w-[1536px] min-[0px]:place-content-center lg:px-4 lg:flex min-[0px]:mx-5 border-solid border-4 border-black shadow-[2px_4px_0px_0px_#000301] min-[0px]:p-7`}>
