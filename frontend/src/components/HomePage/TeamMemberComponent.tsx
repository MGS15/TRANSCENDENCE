...
export default function TeamMember(props: any){
	return (
		<div className={`Member ${props.Color} transition duration-500 ease-in-out font-pixelify max-w-[1536px] min-[0px]:place-content-center lg:px-4 min-[730px]:flex-row lg:flex  border-solid border-4 border-black shadow-[2px_4px_0px_0px_#000301] p-7`}>
		  <div className={` ${props.order} border-solid border-4 border-black bg-white min-[0px]:p-4 sm:p-5 md:p-6 flex place-content-center min-[0px]:w-[40%] sm:w-[35%] min-[0px]:ml-4 lg:m-auto lg:w-[30%] lg:mx-9`}>
		  ...
		  <div className='flex-col mx-4 w-[95%] lg:w-[75%] lg:p-7 lg:m-auto '>
